    ...
    <>
      <style>{`
        ...
        .email-popup-container {
          ...
          margin: 0 auto; // Improved centering with margin auto
        }
        ...
        .email-popup-form-section {
          ...
          flex-direction: column;
          justify-content: center;
          align-items: stretch; // Better centering for form content
        }
        ...
        @media (min-width: 768px) {
          ...
          .email-popup-content.vertical .email-popup-image {
            width: 50%;
            height: auto;
            min-height: 400px; // Better image sizing
          }
          ...
          .email-popup-form-section {
            padding: 3.5rem 3rem; // Increased padding for better spacing
          }
          
          .email-popup-content.single-column .email-popup-form-section {
            max-width: 36rem;
            padding: 3.5rem 3rem; // Better vertical padding for centered layout
          }
        }
