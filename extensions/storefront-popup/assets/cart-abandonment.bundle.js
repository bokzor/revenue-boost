            ...
            /* @__PURE__ */ jsxs("div", { className: "cart-ab-body", children: [
              ...
              config.showCartItems !== false && displayItems.length > 0 && /* @__PURE__ */ jsxs("div", { className: "cart-ab-items", children: [
                displayItems.map((item) => /* @__PURE__ */ jsxs("div", { className: "cart-ab-item", children: [
                  ...
                  /* @__PURE__ */ jsx("div", { className: "cart-ab-item-price", children: formatCurrency(item.price, config.currency) })
                ] }, item.id)),
              ...
              config.showCartTotal !== false && cartTotal && /* @__PURE__ */ jsxs("div", { className: "cart-ab-total", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "cart-ab-footer", children: [
                config.enableEmailRecovery && /* @__PURE__ */ jsxs("form", { onSubmit: handleEmailSubmit, className: "cart-ab-email-form", children: [
