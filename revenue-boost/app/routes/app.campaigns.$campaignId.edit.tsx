...
export default function CampaignEditPage() {
  ...
  const getInitialFormData = (): Partial<CampaignFormData> | null => {
    ...
    return {
      ...
      enhancedTriggers: (campaign.targetRules as any)?.enhancedTriggers || {},
      audienceTargeting: (campaign.targetRules as any)?.audienceTargeting || {},
      frequencyCapping: (campaign.targetRules as any)?.frequencyCapping || {},
