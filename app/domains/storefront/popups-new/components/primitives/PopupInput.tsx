...
export const PopupInput: React.FC<PopupInputProps> = ({
  ...
  const inputStyles: React.CSSProperties = {
    ...
    borderRadius: "8px",
    border: errorText
      ? "1px solid var(--rb-popup-error)"
      : "1px solid var(--rb-popup-input-border)",
  ...
  const handleFocus = (e: React.FocusEvent<HTMLInputElement>) => {
    e.currentTarget.style.outline = errorText
      ? "2px solid var(--rb-popup-error)"
      : "2px solid var(--rb-popup-primary-bg)";
    e.currentTarget.style.outlineOffset = "1px";
    e.currentTarget.style.borderColor = errorText
      ? "var(--rb-popup-error)"
      : "var(--rb-popup-primary-bg)";
  };
