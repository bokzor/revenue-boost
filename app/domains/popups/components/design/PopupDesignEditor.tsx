...
import styles from "./PopupDesignEditor.module.css";
...
export const PopupDesignEditor: React.FC<PopupDesignEditorProps> = ({
  initialConfig,
  initialTemplateId,
  campaignGoal,
  templateType,
  ...
  if (!validCampaignGoals.includes(campaignGoal)) {
    throw new Error(
      `[PopupDesignEditor] Invalid campaign goal: "${campaignGoal}". Must be one of: ${validCampaignGoals.join(", ")}`
    );
  }
...
export default PopupDesignEditor;
