...
const minimalMono: SpinToWinRecipe = {
  ...
  defaults: {
    contentConfig: {
      ...
      emailRequired: true,
      wheelSegments: [
        { id: "prize-1", label: "5% OFF", probability: 0.3, discountConfig: createSegmentDiscount("PERCENTAGE", 5) },
        { id: "prize-2", label: "10% OFF", probability: 0.25, discountConfig: createSegmentDiscount("PERCENTAGE", 10) },
        { id: "prize-3", label: "15% OFF", probability: 0.15, discountConfig: createSegmentDiscount("PERCENTAGE", 15) },
        { id: "prize-4", label: "Try Again", probability: 0.1, discountConfig: NO_DISCOUNT },
        { id: "prize-5", label: "20% OFF", probability: 0.1, discountConfig: createSegmentDiscount("PERCENTAGE", 20) },
        { id: "prize-6", label: "Free Ship", probability: 0.1, discountConfig: createSegmentDiscount("FREE_SHIPPING", 0) },
      ],
      nameFieldEnabled: false,
      consentFieldEnabled: false,
    },
