        ...
        <BlockStack gap="400">
          <BlockStack gap="200">
            ...
            <Text as="p" tone="subdued">
              Configure thresholds and preview cart progress.
            </Text>
          </BlockStack>
          ...
          <Text as="p" tone="subdued">
            Customize messaging for each state.
          </Text>
          <Divider />
          ...
          <Text as="p" tone="subdued">
            Control position and visual behaviors.
          </Text>
          <Divider />
          ...
          <FormGrid columns={2}>
            <SelectField
              ...
              onChange={(value) =>
                updateField("barPosition", value as FreeShippingContent["barPosition"])
              }
            />
