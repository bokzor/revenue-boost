...
export async function loader({ request, params }: LoaderFunctionArgs) {
    console.log("[ExperimentAnalytics] loader hit", { url: request.url, experimentId: params.experimentId });
...
export default function ExperimentAnalyticsPage() {
    ...
    console.log("[ExperimentAnalyticsPage] render", { experimentName, currency, dailyPoints: dailyMetrics.length });
                        ...
                        <BlockStack gap="400">
                            ...
                            <Box paddingBlockStart="400" paddingBlockEnd="200">
                                ...
                                >
                                    ...
                                    <span>{dailyMetrics.length > 0 ? new Date(dailyMetrics[dailyMetrics.length - 1].date).toLocaleDateString() : ''}</span>
                                </div>
                            </Box>
                        </BlockStack>
                    </Box>
