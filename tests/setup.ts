 ...
 *
 * IMPORTANT: Environment variables MUST be set at the top of the file,
 * before any imports that trigger module-level code (like shopify.server.ts
 * which calls validateEnv() at module level).
 */

// Set test environment variables BEFORE any imports
// This is critical because some modules validate env vars at import time
